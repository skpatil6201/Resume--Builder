    ...
    <>
      ...
      {error === true ? (
        <div className="fixed z-50 top-0 right-0 flex flex-col items-center gap-8 w-full h-full p-6 backdrop-blur-sm  text-xl  md:w-[100%]">
          <div className=" min-h-screen flex items-center justify-center ">
            <div className="rounded-lg shadow py-8 px-12 border border-black shadow-lg ">
              ...
              <div className="flex justify-center ">
                <button
                  className=" px-4 py-1 rounded-lg hover:bg-blue-600"
                  onClick={Close}
                >
                  Close
                </button>
      ...
      <div class="flex flex-wrap p-3 w-full justify-center  ">
        ...
        <div style={{ marginLeft: "5vh", marginTop: "5vw" }}>
          {resume !== null ? (
            <>
              <Typography color="primary" style={{ marginBottom: "10px", fontSize: "120%" }}>
                Create File Name
              </Typography>
              <input
                style={{
